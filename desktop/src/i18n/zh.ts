...
export const zh = {
  ...
  home: {
    title: "导出笔记",
    subtitle: "将 Obsidian 笔记转换为通用 Markdown",
    sourceTargetTitle: "来源与目标",
    sourceNamePlaceholder: "未选择 vault",
    destinationNamePlaceholder: "未选择输出文件夹",
  },
  keepRoot: {
    label: "保留根文件夹",
    outputTag: "输出",
    hint: "导出文件夹时在目标目录下创建与来源同名的子文件夹；单篇笔记不套用",
  },
  configSummary: {
    title: "本次转换配置",
    edit: "编辑选项",
    saved: "配置已保存",
    groupConversion: "转换行为",
    groupDiagrams: "图表渲染",
    groupLinkCheck: "链接检查",
    groupOther: "其他非默认选项",
    frontmatter: "Frontmatter",
    comments: "Obsidian 注释",
    embeds: "嵌入笔记",
    embedsRecursive: "展开嵌套嵌入",
    embedsFlat: "不展开嵌套嵌入",
    renderers: "渲染器",
    renderersNone: "未启用",
    renderersFormat: "图片格式",
    linkCheck: "导出后检查",
    linkCheckTarget: "检查目标",
    notApplicable: "不适用",
    on: "开",
    off: "关",
    otherNone: "无",
  ...
  linkCheck: {
    ...
    cancelledTitle: "链接检查已取消",
    failedHint: "事件流未正常终结。",
    cancelledHint: "检查被手动取消，结果不完整。",
    exitCode: "退出码 {code}",
    cancel: "取消检查",
